package com.bnrc.busapp.ui.expandablelistview;
...
public class SwipeMenuLayout extends FrameLayout {
	...
	public SwipeMenuLayout(View contentView, SwipeMenuView menuView, Interpolator closeInterpolator,
		...
		if (mMenuView.getAppearAnimation() != null) {
	...
	public void setGroupPosition(int groupPosition) {
		...
		mMenuView.setGroupPosition(groupPosition);
	}
	...
	public boolean onSwipe(MotionEvent event) {
		...
		case MotionEvent.ACTION_DOWN:
			...
			isFling = false;
			Log.e(TAG, "ACTION_DOWN:DOWN = " + mDownX);
			break;
...
//			isFling=true;
		...
		case MotionEvent.ACTION_UP:
			Log.e(TAG, "ACTION_UP:DOWN = " + mDownX + " x =" + event.getX());
	...
	public void smoothCloseMenu() {
		...
		if (mMenuView.getDisappearAnimation() == null) {
			mCloseScroller.startScroll(0, 0, mBaseX, 0, 350);
		} else {
			mCloseScroller.startScroll(0, 0, mBaseX, 0, 550);
		}
		postInvalidate();
		if (state == STATE_OPEN) {
			mMenuView.startDisappearAnimation(0);
		}
		state = STATE_CLOSE;
	...
	public void smoothOpenMenu() {
		...
		if (state == STATE_CLOSE) {
			mMenuView.startAppearAnimation(0);
		}
		state = STATE_OPEN;
