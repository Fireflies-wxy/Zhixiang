package com.bnrc.bnrcbus.ui.viewpager;
...
//配置属性 START-------------------------------------------------------------------------------------
    ...
    private int dividerPadding = 4;//分隔线上下的padding,dp
    private int dividerWidth = 1;//分隔线宽度,dp

    /*
     * tab
     */
    private int tabTextSize = 14;//tab字号,dp
    private int tabTextColor = Color.parseColor("#FFFFFF");//tab字色
    ...
    private int tabPadding = 16;//每个tab的左右内边距,dp

    /*
     * 被选中的tab
     */
    private int selectedTabTextSize = 16;//dp
    private int selectedTabTextColor = Color.parseColor("#FFFFFF");
...
//setter--------------------------------------------------------------------------------------------
    ...
    public ViewpagerIndicator setExpand(boolean expand) {
        this.expand = expand;
        return this;
    }

    public ViewpagerIndicator setIndicatorWrapText(boolean indicatorWrapText) {
        this.indicatorWrapText = indicatorWrapText;
        return this;
    }

    public ViewpagerIndicator setIndicatorColor(int indicatorColor) {
    ...
    public ViewpagerIndicator setShowUnderline(boolean showUnderline, int underlineColor, int underlineHeight) {
    ...
    public ViewpagerIndicator setShowDivider(boolean showDivider, int dividerColor, int dividerPadding, int dividerWidth) {
    ...
    public ViewpagerIndicator setTabTextSize(int tabTextSize) {
        this.tabTextSize = tabTextSize;
        return this;
    }

    public ViewpagerIndicator setTabTextColor(int tabTextColor) {
        this.tabTextColor = tabTextColor;
        return this;
    }

    public ViewpagerIndicator setTabTypeface(@Nullable Typeface tabTypeface) {
        this.tabTypeface = tabTypeface;
        return this;
    }

    public ViewpagerIndicator setTabTypefaceStyle(int tabTypefaceStyle) {
        this.tabTypefaceStyle = tabTypefaceStyle;
        return this;
    }

    public ViewpagerIndicator setTabBackgroundResId(int tabBackgroundResId) {
        this.tabBackgroundResId = tabBackgroundResId;
        return this;
    }

    public ViewpagerIndicator setTabPadding(int tabPadding) {
        this.tabPadding = tabPadding;
        return this;
    }

    public ViewpagerIndicator setSelectedTabTextSize(int selectedTabTextSize) {
        this.selectedTabTextSize = selectedTabTextSize;
        return this;
    }

    public ViewpagerIndicator setSelectedTabTextColor(int selectedTabTextColor) {
        this.selectedTabTextColor = selectedTabTextColor;
        return this;
    }

    public ViewpagerIndicator setSelectedTabTypeface(@Nullable Typeface selectedTabTypeface) {
        this.selectedTabTypeface = selectedTabTypeface;
        return this;
    }

    public ViewpagerIndicator setSelectedTabTypefaceStyle(int selectedTabTypefaceStyle) {
        this.selectedTabTypefaceStyle = selectedTabTypefaceStyle;
        return this;
    }

    public ViewpagerIndicator setScrollOffset(int scrollOffset) {
