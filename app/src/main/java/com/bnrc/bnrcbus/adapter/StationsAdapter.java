...
import com.bnrc.bnrcbus.model.Bean;
...
import com.bnrc.bnrcbus.view.activity.StationRouteActivity;
...
public class StationsAdapter extends BaseExpandableListAdapter {
	...
	public View getChildView(int groupPosition, int childPosition,
		...
		if (convertView == null) {
			if (isLastChild)
				convertView = inflater.inflate(R.layout.child_loc_stationlist,
						null);
			else
				convertView = inflater.inflate(R.layout.child_loc_stationlist, null);
	...
	public View getGroupView(final int groupPosition, boolean isExpanded,
		...
		if (convertView == null) {
			convertView = inflater.inflate(R.layout.group_concern_stationlist, null);
